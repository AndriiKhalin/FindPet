...
public class GetAllRolesQueryHandler(RoleManager<IdentityRole> roleManager, UserManager<AuthUser> userManager) : IQueryHandler<GetAllRolesQuery, IEnumerable<RoleResponseDto>>
{
